...
def catalog():
    ...
    categories = [b['category'] for b in book_dao.get_all_books() if b.get('category')]
    categories = sorted(list(set(categories)))
    return render_template('view_books.html', books=books, categories=categories, keyword=keyword, category=category, only_available=only_available)
